              ...
              contents: [
                {
                  type: "button",
                  values: {
                    text: ctaMatch[1].toUpperCase(),
                    href: ctaMatch[2],
                    buttonColors: { color: "#FFFFFF", backgroundColor: "#0047BA" },
                    size: { autoWidth: false, width: "100%" },
                    padding: "14px 32px",
                    borderRadius: "0px",
                    containerPadding: "10px",
                    textAlign: "center",
                    fontFamily: { label: "Montserrat", value: "'Montserrat', Arial, sans-serif" },
                    fontWeight: 600,
                    fontSize: "13px",
                    letterSpacing: "2px",
                  },
